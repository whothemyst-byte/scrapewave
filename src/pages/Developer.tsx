...
import { Copy, Check, Key, Webhook, Terminal, Plus, Trash2, Loader2, Eye, EyeOff, AlertTriangle } from 'lucide-react';
...
export default function Developer() {
  ...
  // Get the first active key for examples
  const activeKey = apiKeys.length > 0 ? apiKeys[0] : null;
  const exampleKey = activeKey ? activeKey.key_prefix : 'sk_live_xxxx...';
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="glass rounded-2xl p-6 mb-8 animate-in" style={{ animationDelay: '100ms' }}>
          <div className="flex items-center justify-between mb-4">
            ...
            <Button onClick={handleGenerateKey} disabled={generating || tableNotReady}>
              {generating ? (
          ...
          {loading ? (
            ...
            <div className="text-center py-8 px-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
              ...
              <p className="text-sm text-muted-foreground">
                Run the migration in Supabase SQL Editor to enable API keys.
              </p>
            </div>
          ) : apiKeys.length === 0 ? (
